...
const content = [
  ...
  },
  {
    gameId: 'cronolito',
    sectionKey: 'rules',
    body: 'De 1 a 6 Arquitectos del Tiempo. Empieza una carta al azar en el centro de la Línea del Tiempo con su año a la vista. En cada turno se muestra el título de la siguiente carta (el año permanece oculto) y hay que elegir dónde encaja cronológicamente: al principio, al final, o entre dos cartas ya colocadas. Al soltarla se revela el año: si la posición era correcta, la carta se queda para siempre y la Línea del Tiempo crece; si no, es una Paradoja — pierdes uno de tus 3 estabilizadores temporales y la carta se descarta. Os quedáis sin estabilizadores, se produce un Bucle Temporal (derrota); si agotáis el mazo con al menos un Arquitecto en pie, el Universo se salva (victoria compartida para quien siga vivo). Se puede jugar en solitario o en grupo, turnándose sobre la misma Línea del Tiempo.',
  },
];
